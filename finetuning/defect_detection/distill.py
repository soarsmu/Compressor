...
from model import Model, biLSTM, CNN
from utils import set_seed, TextDataset
from torch.utils.data import DataLoader, SequentialSampler, RandomSampler
from transformers import AdamW, get_linear_schedule_with_warmup, RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer, BertTokenizer
...
def student_train(T_model, S_model, args, train_loader, test_loader):
    ...
    for epoch in range(10):
        ...
        for step, batch in enumerate(bar):
            ...
            # print(t_train_logits[step].shape, s_logits.shape)
            loss.backward()
            optimizer.step()
            scheduler.step()
